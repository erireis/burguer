<html>
    ...
    <body>
        ...
        <div class="Formulario">
            ...
            <h3 id="m2">CPF <br><input type="text" name="cpf" maxlength="11" OnKeyPress="formatar('###.###.###-##', this)" required=""></h3>
